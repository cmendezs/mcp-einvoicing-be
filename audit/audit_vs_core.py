...
import mcp_einvoicing_be  # noqa: E402
from mcp_einvoicing_be.specs import SPECS_DIR as _SPECS_DIR  # noqa: E402

_PACKAGE_ROOT = Path(mcp_einvoicing_be.__file__).resolve().parent
_RESOURCE_PATHS: dict[str, Path] = {
    "mcp_einvoicing_be.specs.SPECS_DIR": _SPECS_DIR,
}
...
def run_check_6() -> CheckResult:
    ...
    pkg_root = Path(__file__).parent.parent / "src" / "mcp_einvoicing_be"
